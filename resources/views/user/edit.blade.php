                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if (auth()->user()->hasRole('organization') ||
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('Company Name') }} <span
                                                        class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <!-- Profile Picture -->
                                        <div
                                            class="bg-light-primary-v2 d-flex flex-column align-items-center justify-content-center gap-3 border border-primary rounded-3 p-5">
