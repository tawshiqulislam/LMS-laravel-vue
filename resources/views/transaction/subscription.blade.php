                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap gap-3 justify-content-between mb-3 align-items-center">
                                ...
                                <div class=" d-flex justify-content-end align-items-center contain-width">
                                    <form action="{{ route('transaction.subscriptions') }}" method="GET" class="w-100 me-2">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a href="{{ route('transaction.subscriptions') }}" class="px-3">
                                    ...
                                    <tbody>
                                        @forelse ($transactions as $transaction)
                                            <tr>
                                                ...
                                                <td class="tableId py-3">{{ \Carbon\Carbon::parse($transaction->subscriber?->ends_at)->format('d M, Y h:i A') }}</td>
                                                <td class="tableId py-3">
